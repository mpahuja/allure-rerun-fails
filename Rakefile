...
#
##WsbRubyAutomation::Application.load_tasks
#
require File.expand_path('../config/application', __FILE__)
require 'rspec/core/rake_task'
require_relative 'spec/helpers/failures_formatter'
...
def first_run(spec_file_pattern)
  ...
  launch(processes: "5".to_i,
         test_options: "--require ./spec/helpers/failures_formatter.rb \
    --format FailureCatcher", spec_file_pattern: spec_file_pattern)
end

def rerun(spec_file_pattern)
  launch(processes: "5".to_i, test_options: "--require ./spec/helpers/re_run_data_collector.rb \
